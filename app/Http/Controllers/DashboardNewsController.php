...
class DashboardNewsController extends Controller
{
    ...
    public function index()
    {
        return view('dashboard.news.index', [
            'lotNews' => News::where('user_id', auth()->user()->id)->latest()->paginate(6)
        ]);
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect('/dashboard/news')->with('success', 'Berita Baru Berhasil Di Buat');
    }
    ...
    public function update(Request $request, News $news)
    {
        ...
        return redirect('/dashboard/news')->with('success', 'Berita Berhasil Di Perbaharui');
    }
